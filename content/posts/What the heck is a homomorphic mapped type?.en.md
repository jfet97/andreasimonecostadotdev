...
So, what properties do homomorphic mapped type have? Oh, and wha about the `as` clause? It allows us to rename or even remove keys, theoretically altering the object's structure.
